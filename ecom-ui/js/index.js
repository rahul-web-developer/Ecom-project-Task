...
const fetchProducts = async () => {
  try {
    ...
    if (data.length === 0) return (productNotFound.style.display = "flex");

    // Product available
    for (let product of data) {
      const ui = `
                <div class="shadow-lg bg-white">
                <img class="w-full h-[220px] object-cover" src="${
                  product.thumbnail
                    ? `${server}/${product.thumbnail}`
                ...
                <div class="p-4">
                    ...
                    <button class="font-bold text-rose-600 text-sm capitalize">${
                      product.brand
                    }</button>
                    ...
                    <div class="flex items-center gap-2 mt-3">
                        <button class="bg-rose-500 text-white font-semibold px-2 py-1 rounded" onclick="checkout('${
                          product._id
        ...
        product.discount
                        ...
                        <button class="bg-green-500 text-white font-semibold px-2 py-1 rounded"
